...
public class MapWidget extends DashboardWidget {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(MapWidget.class);
    ...
    public MapWidget(MetricRegistry metricRegistry, Searches searches, String id, String description, int cacheTime, Map<String, Object> config, String query, TimeRange timeRange, String creatorUserId) throws InvalidWidgetConfigurationException {
        super(metricRegistry, Type.MAP, id, description, cacheTime, config, creatorUserId);
    ...
    protected ComputationResult compute() {
        ...
        final TermsResult terms = searches.terms(field, 500, query, filter, timeRange);
